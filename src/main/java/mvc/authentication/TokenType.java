...
public class TokenType {
	...
	private final Function<Optional<Identity>, List<String>> createHeader;
	
	private TokenType(
			String headerName, 
			Function<String, String> fromValueToToken,
			Function<Optional<Identity>, List<String>> createHeader) {
		this.headerName = headerName;
		this.createHeader = createHeader;
		this.fromValueToToken = fromValueToToken;
	}

	public Function<Optional<Identity>, List<String>> getCreateHeader() {
		return createHeader;
	}
