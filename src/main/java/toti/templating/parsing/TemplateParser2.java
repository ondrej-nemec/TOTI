...
import toti.templating.parsing.structures.InLine;
import toti.templating.parsing.structures.Parser;
import toti.templating.parsing.structures.ParsingNode;
...
public class TemplateParser2 {
	...
	public TemplateParser2(Map<String, Tag> tags, boolean minimalize) {
		this.tags = tags;
