...
public class FormExample implements Module {
	...
	/**
	 * Display inputs
	 * @return http://localhost:8080/examples/form/inputs/{0-100}
	 */
	@Action("inputs")
	 ...
	 * @return http://localhost:8080/examples/form/detail/{0-100}
	 */
	@Action("detail")
	...
	/**
	 * Display inputs
	 * @return http://localhost:8080/examples/form/insert
	 */
	@Action("insert")
	...
	/**
	 * Get data for form
	 * @return http://localhost:8080/examples/form/get/{0-100}
	 */
	@Action("get")
	...
	/**
	 * Save data from form
	 * @return http://localhost:8080/examples/form/save-inputs/{0-100}
	 */
	@Action("save-inputs")
	 ...
	 * @return http://localhost:8080/examples/form/async
	 */
	@Action("async")
	...
	/**
	 * Example of buttons
	 * @return http://localhost:8080/examples/form/buttons
	 */
	@Action("buttons")
	...
	/**
	 * Link for not save
	 * @return http://localhost:8080/examples/form/notsave
	 */
	@Action("notsave")
	 ...
	 * @return http://localhost:8080/examples/form/template
	 */
	@Action("template")
	 ...
	 * @return http://localhost:8080/examples/form/select
	 */
	@Action("select")
	@Method(HttpMethod.GET)
	...
	/**
	 * Options for select
	 * @return http://localhost:8080/examples/form/load-select
	 */
	@Action("load-select")
	...
	/**
	 * Options for select
	 * @return http://localhost:8080/examples/form/load-optgroup
	 */
	 ...
	 * @return http://localhost:8080/examples/form/datetime
	 */
	@Action("datetime")
	 ...
	 * @return http://localhost:8080/examples/form/optional
	 */
	@Action("optional")
	...
	/**
	 * Shows extended inputs
	 * @return http://localhost:8080/examples/form/checkbox
	 */
	@Action("checkbox")
	 ...
	 * @return http://localhost:8080/examples/form/exclude
	 */
	@Action("exclude")
	 ...
	 * @return http://localhost:8080/examples/form/not-editable
	 */
	@Action("not-editable")
	...
	/**
	 * Not editable form with editable input
	 * @return http://localhost:8080/examples/form/editable
	 */
	@Action("editable")
	 ...
	 * @return http://localhost:8080/examples/form/redirect
	 */
	@Action("redirect")
	 ...
	 * @return http://localhost:8080/examples/form/after-redirect-save
	 */
	...
	/**
	 * For after form submit
	 * @return http://localhost:8080/examples/form/after-redirect
	 */
	...
	/**
	 * Redirect after async form submit
	 * @return http://localhost:8080/examples/form/file
	 */
	@Action("file")
	...
	/**
	 * Redirect after async form submit
	 * @return http://localhost:8080/examples/form/file-save
	 */
	@Action("file-save")
	...
	/**
	 * Using form callbaks
	 * @return http://localhost:8080/examples/form/callbacks
	 */
	@Action("callbacks")
	...
	/**
	 * Using input list
	 * @return http://localhost:8080/examples/form/inputlist
	 */
	@Action("inputlist")
	 ...
	 * @return http://localhost:8080/examples/form/inputlist-template
	 */
	...
	/**
	 * Data for input list
	 * @return http://localhost:8080/examples/form/inputlist-data
	 */
	 ...
	 * @return http://localhost:8080/examples/form/dynamiclist
	 */
	@Action("dynamiclist")
	 ...
	 * @return http://localhost:8080/examples/form/dynamiclist-template
	 */
	...
	/**
	 * Data for input list
	 * @return http://localhost:8080/examples/form/dynamiclist-data
	 */
	 ...
	 * @return http://localhost:8080/examples/form/dynamiclist-buttons
	 */
	...
	public String getTranslationPath() {
		return "toti/translations"; // "samples/examples/form";
	}

	public static void main(String[] args) {
		List<Module> modules = Arrays.asList(new FormExample());
		try {
