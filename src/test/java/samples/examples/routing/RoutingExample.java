package samples.examples.routing;
...
public class RoutingExample implements Module {
	 ...
	 * @return
	 *  http://localhost:8080/examples/routing/secured
	 ...
	 * @return
	 *  http://localhost:8080/examples/routing/unsecured
	 *  OR with another pattern
	 ...
	 * @return 
	 *  http://localhost:8080/examples/routing/notAccessible
	 *  OR with another pattern
	 ...
	 * @return
	 *  http://localhost:8080/examples/routing/accessible
	 *  http://localhost:8080/examples/routing/notAccessible
	 *  http://localhost:8080
	 *  OR with another pattern
	 ...
	 * @return 
	 *  http://localhost:8080/examples/routing/links
	 *  OR with another pattern
	...
	public static void main(String[] args) {
		List<Module> modules = Arrays.asList(new RoutingExample());
		try {
	...
	public String getControllersPath() {
		return "samples/examples/routing";
	}
