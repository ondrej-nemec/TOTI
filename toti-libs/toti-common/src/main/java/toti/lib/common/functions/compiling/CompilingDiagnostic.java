package toti.lib.common.functions.compiling;
...
public class CompilingDiagnostic extends Writer implements DiagnosticListener<JavaFileObject> {
	...
	public CompilingDiagnostic(String namespace, String file) {
